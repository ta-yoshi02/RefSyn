...
\begin{itemize}
  \item \texttt{editEdge}: main-new1, main-new1-val, null, val
  \item \texttt{editEdge}: main-new1, main-new2, null, next
\end{itemize}

\subsubsection{\texttt{lst2.clear()} に対する操作}
\begin{itemize}
  \item \texttt{editEdge}: main-new4, main-new4-val, null, val
\end{itemize}
...
\subsubsection{\texttt{lst2.clear()}}
\begin{lstlisting}[language=JavaScript]
this.val = null;
\end{lstlisting}
...
\subsubsection{\texttt{lst.update(0, 10)} に対する操作}
\begin{itemize}
  \item \texttt{addNode}: \_\_temp1, 10, true, string
  \item \texttt{editEdgeReference}: main-new2, main-new2-val, \_\_temp1, val
  \item \texttt{addNode}: \_\_temp2, 10, true, string
  \item \texttt{editEdgeReference}: main-new4, main-new4-val, \_\_temp2, val
\end{itemize}

\subsubsection{\texttt{lst.update(3, 100)} に対する操作}
\begin{itemize}
  \item \texttt{addNode}: \_\_temp3, 100, true, string
  \item \texttt{editEdgeReference}: main-new3, main-new3-val, \_\_temp3, val
\end{itemize}

\subsection{手動で復元したコード}

\subsubsection{\texttt{lst.update(0, 10)}}
\begin{lstlisting}[language=JavaScript]
var temp1 = 10;
this.next.val = temp1;
var temp2 = 10;
...
\subsubsection{\texttt{lst.update(3, 100)}}
\begin{lstlisting}[language=JavaScript]
