...
mod tests {
    ...
    fn test_dynamic_append_operation_analysis() {
        ...
        assert_eq!(analysis.object_declarations.get("list"), Some(&"main-new1".to_string()));
        assert_eq!(analysis.object_declarations.get("lst"), Some(&"main-new2".to_string()));
    ...
    fn test_multiple_receivers_analysis() {
        ...
        assert_eq!(analysis.object_declarations.get("list1"), Some(&"main-new1".to_string()));
        assert_eq!(analysis.object_declarations.get("list2"), Some(&"main-new2".to_string()));
        assert_eq!(analysis.object_declarations.get("temp"), Some(&"main-new3".to_string()));
    ...
    fn test_realistic_linked_list_program() {
        ...
        for (i, call) in analysis.method_calls.iter().enumerate() {
            println!("  {}: {}.{}() -> receiver_id: {}", i, call.receiver_var, call.method_name, call.receiver_id);
        }
