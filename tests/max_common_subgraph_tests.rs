...
fn append_ops_permuted() -> Vec<Op> {
    /*
    addNode("__temp1", true, "0"),
    addNode("__temp2", false, "Node"),
    addEdge("main-new1", "__temp2", "next"),
    addEdge("__temp2", "__temp1", "val")
    */
    vec![
        Op {
            id: "op_0".to_string(),
...
fn remove_at_ops_original() -> Vec<Op> {
    vec![
        Op {
            id: "op_0".to_string(),
            kind: OpKind::EditEdgeReference {
                from: "main-new2".to_string(),
                old_to: "main-new3".to_string(),
                new_to: "main-new4".to_string(),
                label: "next".to_string(),
            },
        },
        Op {
...
fn concat_ops_permuted() -> Vec<Op> {
    vec![Op {
        id: "op_0".to_string(),
        kind: OpKind::AddEdge {
            from: "main-new5".to_string(),
            to: "main-new6".to_string(),
            label: "next".to_string(),
        },
    }]
}
...
fn set_ops_original() -> Vec<Op> {
    vec![
        ...
        Op {
            ...
            kind: OpKind::EditEdgeReference {
                from: "main-new3".to_string(),
                old_to: "main-new3-val".to_string(),
                new_to: "__temp1".to_string(),
                label: "val".to_string(),
            },
        },
...
fn set_ops_permuted() -> Vec<Op> {
    vec![
        ...
        Op {
            ...
            kind: OpKind::EditEdgeReference {
                from: "main-new2".to_string(),
                old_to: "main-new2-val".to_string(),
                new_to: "__temp2".to_string(),
                label: "val".to_string(),
            },
        },
    ]
...
fn add2_nodes_ops_b() -> Vec<Op> {
    vec![
        ...
        Op {
            id: "op_3".to_string(),
            kind: OpKind::AddEdge {
                from: "__temp7".to_string(),
                to: "__temp5".to_string(),
                label: "next".to_string(),
            },
        },
        Op {
        ...
        Op {
            id: "op_7".to_string(),
            kind: OpKind::AddEdge {
                from: "__temp5".to_string(),
                to: "__temp8".to_string(),
                label: "val".to_string(),
            },
        },
    ]
